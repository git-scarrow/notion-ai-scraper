...
- Tools: `list_agents`, `list_workspace_agents`, `sync_registry`, `dump_agent`, `update_agent`, `publish_agent`, `discover_agent`, `register_agent`, `remove_agent`
...
| File | Purpose |
|---|---|
| `cli/mcp_server.py` | MCP server (9 tools) |
